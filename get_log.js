...
(async () => {
  ...
  await page.setContent(`
    ...
    $3Dmol.download("pdb:1HVR", viewer, {doAssembly:false, noComputeSecondaryStructure: false}, function() {
      const m = viewer.getModel(0);
      const atoms = m.selectedAtoms({});
      console.log("Atom 0 chain:", atoms[0].chain, "resi:", atoms[0].resi, "ss:", atoms[0].ss);
    });
    </script>
    </body>
    </html>
