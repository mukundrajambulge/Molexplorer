...
(async () => {
  ...
  await page.setContent(`
    ...
    $3Dmol.download("pdb:1HVR", viewer, {doAssembly:false}, function() {
      ...
      viewer.setStyle({ss: 'h'}, { cartoon: { style: 'oval', thickness: 0.4, color: 'green' } });
      viewer.setStyle({ss: 's'}, { cartoon: { style: 'edged', thickness: 0.4, arrows: true, color: 'green' } });
      viewer.setStyle({ss: 'c'}, { cartoon: { style: 'tube', radius: 0.2, color: 'green' } });
      viewer.render();
