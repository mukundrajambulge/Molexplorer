...
(async () => {
  ...
  await page.setContent(`
    ...
    fetch("https://files.rcsb.org/download/1HVR.pdb").then(r => r.text()).then(pdb => {
      ...
      console.log("Atom 25 chain:", atoms[100].chain, "resi:", atoms[100].resi, "ss:", atoms[100].ss);
      
      viewer.setStyle({hetflag: false}, { cartoon: { color: 'spectrum', arrows: true, tubes: true } });
      viewer.render();
